...
Config.Discord = {
    ...
    applicationId = '1331451445014171709',                   -- The discord application id
    iconLarge = '1024x1024Logo',                               -- The name of the large icon
    iconLargeHoverText = 'Join Cornerstone RP!', -- The hover text of the large icon
    iconSmall = '512x512Logo',                         -- The name of the small icon
    iconSmallHoverText = 'More Info in CRP Discord', -- The hover text of the small icon
    updateRate = 60000,                                    -- How often the player count should be updated
    showPlayerCount = true,                                -- If set to true the player count will be displayed in the rich presence
    maxPlayers = 48,                                       -- Maximum amount of players
    buttons = {
        {
            text = 'Join CRP Discord!',
            url = 'https://discord.gg/4pMrFFX8TE'
        },
        {
            text = 'Join CRP Discord!',
            url = 'https://discord.gg/4pMrFFX8TE'
